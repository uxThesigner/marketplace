...
<head>
    ...
    <style>
        ...
        .btn-logout:active { background: #fecaca; }
        .version-text { text-align: center; margin-top: 20px; font-size: 12px; color: #ccc; }

        /* Estilos dos Seletores de Tema e Idioma */
        .theme-grid {
            display: grid;
...
<body>
    ...
    <main class="app-content" style="padding-top: 20px;">
        ...
        <div class="profile-card">
            ...
            <div class="plan-badge">
                <i class="ph ph-crown-simple"></i> Enterprise
            </div>
        </div>
        ...
        <div class="settings-group">
            ...
            <div class="settings-item">
                <div class="settings-icon"><i class="ph ph-credit-card"></i></div>
                <div class="settings-text" data-i18n="item_sub">Assinatura & Faturas</div>
                <i class="ph ph-caret-right settings-arrow"></i>
            </div>
        </div>
        ...
        <div class="settings-group">
            <div class="settings-item">
                ...
                <i class="ph ph-toggle-right" style="font-size: 24px; color: var(--primary-color);"></i>
            </div>

            <div class="settings-item" onclick="toggleModal('modal-theme-select')">
                <div class="settings-icon"><i class="ph ph-paint-bucket"></i></div>
                <div class="settings-text" data-i18n="item_theme">Aparência (Tema)</div>
                <div style="width: 20px; height: 20px; border-radius: 50%; background: var(--primary-color);"></div>
            </div>

            <div class="settings-item" onclick="toggleModal('modal-lang-select')">
                <div class="settings-icon"><i class="ph ph-globe"></i></div>
                <div class="settings-text" data-i18n="item_lang">Idioma (Language)</div>
                <i class="ph ph-caret-right settings-arrow"></i>
            </div>
        ...
        <p class="version-text">Versão MVP 1.0.0 • Koda System</p>
    ...
    <div id="modal-theme-select" class="modal-overlay hidden">
        <div class="modal-content bottom-sheet">
            <div class="modal-header">
                <h2 data-i18n="modal_theme_title">Escolha um Tema</h2>
                <button class="btn-icon" onclick="toggleModal('modal-theme-select')"><i class="ph ph-x"></i></button>
            </div>
            <div class="modal-body">
                <p class="helper-text">Selecione a cor principal do sistema:</p>
                <div class="theme-grid">
                    <div class="theme-option" style="background: #4D5D53;" onclick="changeAppTheme('#4D5D53'); toggleModal('modal-theme-select')"></div>
                    <div class="theme-option" style="background: #2563EB;" onclick="changeAppTheme('#2563EB'); toggleModal('modal-theme-select')"></div>
                    <div class="theme-option" style="background: #7C3AED;" onclick="changeAppTheme('#7C3AED'); toggleModal('modal-theme-select')"></div>
                    <div class="theme-option" style="background: #EA580C;" onclick="changeAppTheme('#EA580C'); toggleModal('modal-theme-select')"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="modal-lang-select" class="modal-overlay hidden">
        <div class="modal-content bottom-sheet">
            ...
            <div class="modal-body">
                <div class="lang-list">
                    <button class="lang-option" onclick="changeAppLanguage('pt'); toggleModal('modal-lang-select')" data-lang="pt">
                        <span style="font-size: 24px;">🇧🇷</span> Português
                    </button>
                    <button class="lang-option" onclick="changeAppLanguage('en'); toggleModal('modal-lang-select')" data-lang="en">
                        <span style="font-size: 24px;">🇺🇸</span> English
                    </button>
                    <button class="lang-option" onclick="changeAppLanguage('es'); toggleModal('modal-lang-select')" data-lang="es">
                        <span style="font-size: 24px;">🇪🇸</span> Español
                    </button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            if (typeof appConfig !== 'undefined') {
                document.getElementById('config-name').textContent = appConfig.user.name;
                document.getElementById('config-avatar').textContent = appConfig.user.avatarInitials;
            }
        });

        // 3. Logout
        function doLogout() {
            // Usa tradução para o alerta também
